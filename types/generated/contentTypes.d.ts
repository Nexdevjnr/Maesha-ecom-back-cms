...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adresse_rue: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    produit_commandes: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProduitCommandeProduitCommande
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nom_produit: Schema.Attribute.String & Schema.Attribute.Required;
    prix_unitaire: Schema.Attribute.Decimal & Schema.Attribute.Required;
    produit: Schema.Attribute.Relation<'manyToOne', 'api::produit.produit'>;
    publishedAt: Schema.Attribute.DateTime;
    quantite: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::produit-commande.produit-commande': ApiProduitCommandeProduitCommande;
